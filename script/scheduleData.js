...
/* 세부 시간표가 있는 날 — 세션 단위 (s: 시작, e: 끝, t: 제목)
   timetable.js가 이 데이터가 있는 날은 시간대별 세션 목록으로 그린다. */
var SKALA_DAY_SESSIONS = {
  "2026-07-24": [
    { s: "09:00", e: "09:30", t: "CSS 심화 1" },
    { s: "09:30", e: "10:00", t: "CSS 심화 2" },
    { s: "10:10", e: "10:50", t: "종합실습 — CSS 심화" },
    { s: "11:00", e: "11:40", t: "JavaScript 기초 1" },
    { s: "11:50", e: "12:20", t: "JavaScript 기초 2" },
    { s: "13:40", e: "14:10", t: "JavaScript 기초 3" },
    { s: "14:10", e: "15:00", t: "종합실습 — JavaScript 기초 프로그래밍" },
    { s: "15:10", e: "16:00", t: "JavaScript 심화" },
    { s: "16:10", e: "16:50", t: "종합실습 — JavaScript 심화" },
    { s: "17:00", e: "17:50", t: "과제보완" }
  ],
  "2026-07-27": [
    { s: "09:00", e: "10:00", t: "과정 소개 및 일차별 주요 사항 공유, 데이터베이스 개요" },
    { s: "10:00", e: "11:00", t: "관계형 모델 핵심 개념" },
    { s: "11:00", e: "12:20", t: "ERD 및 오전 정리" },
    { s: "13:40", e: "14:40", t: "모델 설계, 스키마 전략 & RDBMS 비교" },
    { s: "14:40", e: "15:40", t: "DML, DDL 및 종합실습 안내" },
    { s: "16:00", e: "18:00", t: "종합실습" }
  ],
  "2026-07-28": [
    { s: "09:00", e: "10:00", t: "1일차 리뷰 & DB 생태계 & 오늘의 Milestone" },
    { s: "10:00", e: "11:00", t: "SQL 중급 (집계, 그룹화, JOIN 알고리즘)" },
    { s: "11:00", e: "12:20", t: "JOIN 종류 상세" },
    { s: "13:40", e: "14:40", t: "서브쿼리 & 집합연산자, CTE, VIEW, Materialized View" },
    { s: "14:40", e: "15:40", t: "Window function 및 종합실습 안내" },
    { s: "16:00", e: "18:00", t: "종합실습" }
  ],
  "2026-07-29": [
    { s: "09:00", e: "10:00", t: "1,2일차 리뷰 & 오늘의 Milestone, 인덱스 설계 및 최적화" },
    { s: "10:00", e: "11:00", t: "실행계획 분석" },
    { s: "11:00", e: "12:20", t: "SQL 튜닝 & 느린 쿼리 식별" },
    { s: "13:40", e: "14:40", t: "Lock & Dead Lock 관리" },
    { s: "14:40", e: "15:40", t: "고급 DB 설계 및 종합실습 안내" },
    { s: "16:00", e: "18:00", t: "종합실습" }
  ],
  "2026-07-30": [
    { s: "09:00", e: "10:00", t: "1,2,3일차 리뷰 & 오늘의 Milestone, Stored Procedure & 함수" },
    { s: "10:00", e: "11:00", t: "Trigger & 이벤트 처리" },
    { s: "11:00", e: "12:20", t: "Cloud DB 개요" },
    { s: "13:40", e: "14:40", t: "분산 Cloud DB, 데이터웨어하우스, Trend, 보안 및 권한관리" },
    { s: "14:40", e: "15:40", t: "백업/복구, 모니터링과 운영 및 종합실습 안내" },
    { s: "16:00", e: "18:00", t: "종합실습" }
  ],
  "2026-07-31": [
    { s: "09:00", e: "09:50", t: "Vue.js 시작하기" },
    { s: "10:00", e: "10:50", t: "종합실습" },
    { s: "11:00", e: "11:40", t: "Vue 기본 문법 (1)" },
    { s: "11:50", e: "12:20", t: "Vue 기본 문법 (2-1)" },
    { s: "13:40", e: "14:20", t: "Vue 기본 문법 (2-2)" },
    { s: "14:30", e: "15:20", t: "Vue 기본 문법 (3)" },
    { s: "15:30", e: "16:20", t: "Vue 기본 문법 (4)" },
    { s: "16:30", e: "17:50", t: "종합실습" }
  ],
  "2026-08-03": [
    { s: "09:00", e: "09:40", t: "Composition API (1)" },
    { s: "09:50", e: "10:50", t: "Composition API (2)" },
    { s: "11:00", e: "11:50", t: "종합실습" },
    { s: "12:00", e: "12:20", t: "컴포넌트 다루기 (1-1)" },
    { s: "13:40", e: "14:00", t: "컴포넌트 다루기 (1-2)" },
    { s: "14:10", e: "15:20", t: "컴포넌트 다루기 (2)" },
    { s: "15:30", e: "16:00", t: "컴포넌트 다루기 (3)" },
    { s: "16:10", e: "17:50", t: "종합실습" }
  ],
  "2026-08-04": [
    { s: "09:00", e: "09:50", t: "Vue Router" },
    { s: "10:00", e: "10:50", t: "종합실습" },
    { s: "11:00", e: "11:40", t: "Pinia" },
    { s: "11:50", e: "12:20", t: "종합실습" },
    { s: "13:40", e: "14:00", t: "종합실습" },
    { s: "14:10", e: "15:25", t: "Axios" },
    { s: "15:40", e: "16:50", t: "종합실습" },
    { s: "17:00", e: "17:50", t: "종합실습" }
  ],
  "2026-08-05": [
    { s: "09:00", e: "09:50", t: "UI 라이브러리" },
    { s: "10:00", e: "10:50", t: "종합실습" },
    { s: "11:00", e: "11:50", t: "Modern JavaScript" },
    { s: "12:00", e: "12:20", t: "종합실습" },
    { s: "13:40", e: "14:10", t: "종합실습" },
    { s: "14:20", e: "15:10", t: "Vite 빌드 및 실무 배포" },
    { s: "15:20", e: "16:10", t: "종합실습" },
    { s: "16:20", e: "17:50", t: "Code Review" }
  ],
  "2026-08-10": [
    { s: "09:00", e: "09:50", t: "프로그램 기초, Java 둘러보기, 개발환경 구성하기" },
    { s: "10:00", e: "10:50", t: "Java 변수와 자료형, 네이밍 규칙" },
    { s: "11:00", e: "12:20", t: "클래스와 객체, 주석 달기, Java 제어문 (1)" },
    { s: "13:40", e: "14:30", t: "Java 제어문 (2)" },
    { s: "14:40", e: "15:30", t: "Java 패키지, Java 필수 클래스" },
    { s: "15:40", e: "16:30", t: "객체지향 프로그래밍" },
    { s: "16:40", e: "17:00", t: "Java 내부 구조" }
  ],
  "2026-08-11": [
    { s: "09:00", e: "09:50", t: "상속, 인터페이스, 추상화, 다형성" },
    { s: "10:00", e: "10:50", t: "Collection Type" },
    { s: "11:00", e: "12:20", t: "Generic Type" },
    { s: "13:40", e: "14:30", t: "Lambda Expression" },
    { s: "14:40", e: "15:30", t: "Stream API 및 Java Util 클래스" },
    { s: "15:40", e: "16:30", t: "Reflection 및 Annotation" },
    { s: "16:40", e: "17:00", t: "조별 개념 토론" }
  ],
  "2026-08-12": [
    { s: "09:00", e: "09:50", t: "생성 패턴 및 SOLID" },
    { s: "10:00", e: "10:50", t: "Network 및 Socket 통신" },
    { s: "11:00", e: "12:20", t: "REST API 및 Spring 개요" },
    { s: "13:40", e: "14:30", t: "Spring Boot 만들기 및 MVC 모델" },
    { s: "14:40", e: "15:30", t: "Controller 및 HTTP 매개변수" },
    { s: "15:40", e: "16:30", t: "Service 및 Repository" },
    { s: "16:40", e: "17:00", t: "Spring MVC Framework 이해 및 실습" }
  ],
  "2026-08-13": [
    { s: "09:00", e: "09:50", t: "Lombok 및 Properties 이해" },
    { s: "10:00", e: "10:50", t: "DI 및 IoC Container" },
    { s: "11:00", e: "12:20", t: "IoC Container 및 DI 실습" },
    { s: "13:40", e: "14:30", t: "Proxy Pattern" },
    { s: "14:40", e: "15:30", t: "AOP" },
    { s: "15:40", e: "16:30", t: "입력값 검증" },
    { s: "16:40", e: "17:00", t: "Async" }
  ],
  "2026-08-14": [
    { s: "09:00", e: "09:50", t: "JPA" },
    { s: "10:00", e: "10:50", t: "JPA Repository" },
    { s: "11:00", e: "12:20", t: "관계 매핑 및 Entity Manager" },
    { s: "13:40", e: "14:30", t: "Transactional" },
    { s: "14:40", e: "15:30", t: "REST API 문서화" },
    { s: "15:40", e: "16:30", t: "Actuator" },
    { s: "16:40", e: "17:00", t: "Quiz 및 실습" }
  ]
};
